	...
	return <>
        <nav className={styles.topNavigation}>
            ...
            <div className={styles.middleNavDiv}>
                ...
                <Link href={"/global-chat"} className={styles.navLink}>
                ...
                <Link href={"/school-forum"} className={styles.navLink}>
                ...
                <Link href={"/class-schedule"} className={styles.navLink}>
                ...
                <Link href={"/forms-and-surveys"} className={styles.navLink}>
